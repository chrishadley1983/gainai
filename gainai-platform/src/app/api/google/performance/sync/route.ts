...
import { syncPerformanceForLocation } from '@/lib/google/performance'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const syncedCount = await syncPerformanceForLocation(locationId)
    ...
    console.error('Google performance sync error:', error)
    return NextResponse.json(
